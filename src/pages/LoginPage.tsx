...
export const LoginPage: React.FC = () => {
  ...
  const [emailInput, setEmailInput] = useState<string>(users[0]?.email || 'tejas@inbox.GoldMine.io');
          ...
          <div className="p-6 sm:p-8 space-y-5">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  type="button"
                  onClick={() => handleQuickFill('tejas@inbox.GoldMine.io')}
                ...
                <button
                  type="button"
                  onClick={() => handleQuickFill('rahul.s@inbox.GoldMine.io')}
                  className="flex items-center gap-2 p-2 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50/70 dark:bg-zinc-800/50 hover:border-blue-500 text-left transition"
                >
                ...
                <button
                  type="button"
                  onClick={() => handleQuickFill('priya.p@inbox.GoldMine.io')}
                  className="flex items-center gap-2 p-2 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50/70 dark:bg-zinc-800/50 hover:border-blue-500 text-left transition"
                >
                ...
                <button
                  type="button"
                  onClick={() => handleQuickFill('amit.shah@inbox.GoldMine.io')}
                  className="flex items-center gap-2 p-2 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50/70 dark:bg-zinc-800/50 hover:border-blue-500 text-left transition"
                >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="name@inbox.GoldMine.io"
